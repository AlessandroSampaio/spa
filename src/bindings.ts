...
export type PurchaseParameters = { target_stock_days: number }
...
rename_list: (id: number, name: string) => Promise<null>, 
save_purchase_parameters: (params: PurchaseParameters) => Promise<null>},
